...
function renderDonutOrBar(sYears) {
    ...
    if (!isMultiYear) {
        document.getElementById('donutTitle').innerHTML = `📊 สัดส่วนเป้าหมาย <small>(คลิกดูรายละเอียด)</small>`;
        ...
        document.getElementById('donutTitle').innerHTML = `📊 เปรียบเทียบเป้าหมายรายปี <small>(คลิกดูรายละเอียด)</small>`;
...
// 🌟 อัปเดต Map ให้โชว์งบ Provincial ใน Popup ให้ชัดเจน
